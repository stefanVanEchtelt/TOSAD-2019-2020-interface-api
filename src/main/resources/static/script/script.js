...
function getCardHtml(ruleName, ruleId, run) {
    let html =
        ...
        html +=
        "               <a class=\"btn btn-info mr-3\" href=rule.html?column=" + column_name + "&table=" + table_name + "&rule=" + ruleId + "\>Edit</a><a class=\"btn btn-info mr-3\" href=\"#.html\">Delete</a><a class=\"btn btn-info\" href=\"table.html\">Terug</a>\n" +
        "              </p>" +
        "            </div>\n" +
        "          </div>\n" +
        "        </div>\n" +
